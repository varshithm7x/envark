...
const TOOL_HANDLERS = {
    get_env_map: (args) => getEnvMap(args),
    get_env_risk: (args) => getEnvRisk(args),
    get_missing_envs: (args) => getMissingEnvs(args),
    get_duplicates: (args) => getDuplicates(args),
    get_undocumented: (args) => getUndocumented(args),
    get_env_usage: (args) => getEnvUsage(args),
    get_env_graph: (args) => getEnvGraph(args),
    validate_env_file: (args) => validateEnvFile(args),
    generate_env_template: (args) => generateEnvTemplate(args),
};
/**
