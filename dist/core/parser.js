 ...
 */
export function parseFile(filePath, relativePath) {
 ...
 */
function parseJavaScriptTypeScript(lines, filePath, relativePath, language) {
    const usages = [];
    // Patterns to detect
    const patterns = [
 ...
 * Parse Python files
 */
function parsePython(lines, filePath, relativePath) {
    const usages = [];
    const patterns = [
 ...
 * Parse Go files
 */
function parseGo(lines, filePath, relativePath) {
    const usages = [];
    const patterns = [
        // os.Getenv("VAR")
 ...
 * Parse Rust files
 */
function parseRust(lines, filePath, relativePath) {
    const usages = [];
    const patterns = [
 ...
 */
function parseShell(lines, filePath, relativePath) {
    const usages = [];
    lines.forEach((line, lineIndex) => {
        // Skip comments
 ...
 * Parse Dockerfile
 */
function parseDockerfile(lines, filePath, relativePath) {
    const usages = [];
    lines.forEach((line, lineIndex) => {
        const trimmed = line.trim();
        // Skip comments
 ...
 */
function parseYaml(lines, filePath, relativePath) {
    const usages = [];
 ...
 * Parse .env files
 */
function parseEnvFile(lines, filePath, relativePath) {
    const usages = [];
    let pendingComment;
    lines.forEach((line, lineIndex) => {
        const trimmed = line.trim();
